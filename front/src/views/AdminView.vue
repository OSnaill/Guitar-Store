    ...
    <main>
        <article class="max-w-[1280px] m-auto p-4 grid grid-cols-3 gap-4">
            <section class=" col-span-1 flex flex-col gap-4">
                <BrandForm />
                <div>
                    <div class="flex flex-row justify-between border border-solid rounded-lg shadow-xl items-center p-4">
                        <h4>Marques</h4>
                    </div>
                    <table class="table-auto m-auto p-4">
                        ...
                        <tbody>
                            <tr v-for="brand in brandStore.brands">
                                <td>{{  brand.id  }}</td>
                                <td> {{ brand.name }} </td>
                                <td> <a href="#" >
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class=" fill-yellow-500">
